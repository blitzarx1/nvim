...
-- to show / hide special characters use
-- :set list / :set nolist correspondingly
...
-- FLOATING TERMINAL 
--
-- (credits https://github.com/radleylewis/nvim-lite/blob/pluginless/init.lua)
-- ============================================================================
